...
# splits each transaction into its own sublist
daily_transactions_split = [sales.split("|") for sales in daily_transactions]
...
sales = [t[1] for t in transactions_clean]
thread_sold = [t[2] for t in transactions_clean]
# print(customers)
# print(sales)
# print(thread_sold)

# finds the sum of sales
total_sales = sum(float(i.strip("$")) for i in sales)
